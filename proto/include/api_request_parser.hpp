...
namespace ipc {
    ...
    inline pico::AxisConfig::DirectionsMapping ApiRequestParser::parse_directions_mapping(const service_api_DirectionsMapping& pb_directions) {
        const auto directions_mapping = std::map<service_api_StepperDirection, pico::PicoStepper::Direction> {
            {service_api_StepperDirection_CW, pico::PicoStepper::Direction::CW},
            {service_api_StepperDirection_CCW, pico::PicoStepper::Direction::CCW},
        };
