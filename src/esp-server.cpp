...
static esp_err_t example_connect(void) {
    throw std::runtime_error("example_connect is not implemented");
}

static void example_uri_decode(char *dest, const char *src, size_t len) {
    throw std::runtime_error("example_uri_decode is not implemented");
}
